    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="bi bi-chat"></i> Digi Spot</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                ...
                                <p class="card-text">Development. Jan 2024</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                ...
                                <p class="card-text">UI/UX Jun 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Travel Website</h4>
                                <p class="card-text">UI/UX Feb 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">SaaS Website</h4>
                                <p class="card-text">Development. May 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>Chitkara University<br>Punjab, 140401</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Call Us</h3>
                                <p>+91 7085250819<br>+91 9118079002</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Email Us</h3>
                                <p>yashkalra2013@gmail.com<br>yash1578.be21@chitkara.edu.in</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="logo"><i class="bi bi-chat"></i> Digi Spot</p>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <ul class="d-flex">
                        <li><a href="#">Home</a></li>
